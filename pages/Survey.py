...
# PAGE CONFIGURATION
st.set_page_config(
    page_title="Screen Time Survey",
    page_icon="📝",
)

# PAGE TITLE AND USER DIRECTIONS
st.title("Screen Time Survey 📝")
st.write("Please fill out the form below to share your daily screen time habits.")
...
with st.form("survey_form"):
    ...
    category_input = st.text_input("What device do you spend the most time on? (e.g., Phone, Laptop, Tablet):")
    value_input = st.text_input("How many hours per day do you spend on it?")
    ...
    if submitted:
        ...
        st.write(f"You entered: **Device:** {category_input}, **Hours/Day:** {value_input}")
